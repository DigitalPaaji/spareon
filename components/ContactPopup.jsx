...
<div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm p-8 md:p-4">
  <div className="relative w-full max-w-4xl overflow-hidden rounded-2xl lg:rounded-3xl bg-white shadow-2xl max-h-[95vh] overflow-y-auto"> <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.2fr]">
          <div className="bg-gradient-to-br from-[#056483] to-[#0A162B] px-6 py-8 sm:px-8 sm:py-10 text-white flex flex-col justify-center">
